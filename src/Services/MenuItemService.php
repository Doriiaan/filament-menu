...
namespace Doriiaan\FilamentMenu\Services;
...
class MenuItemService
{
    public function __construct(
        protected FilamentMenuPlugin $plugin = new FilamentMenuPlugin,
    ) {
        $this->plugin = FilamentMenuPlugin::get();
    }
    ...
    public function findByIdWithRelations(int $id): ?MenuItem
    {
    ...
    public function getPreviousSibling(MenuItem $item): ?MenuItem
    {
        return $this->getModel()::query()
