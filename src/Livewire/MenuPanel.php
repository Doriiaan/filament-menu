...
use Doriiaan\FilamentMenu\Contracts\MenuPanel as ContractsMenuPanel;
...
class MenuPanel extends Component implements HasForms
{
    ...
    public function form(Schema $form): Schema
    {
        ...
        return $form
            ->schema([
                Components\View::make('filament-menu::components.empty-state')
                    ->viewData([
                        'heading' => __('filament-menu::menu.panel.empty.heading'),
                        'description' => __('filament-menu::menu.panel.empty.description'),
    ...
    {
        return view('filament-menu::livewire.menu-panel');
    }
}
