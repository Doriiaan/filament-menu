 ...
 * @property-read \Doriiaan\FilamentMenu\Models\Menu $menu
 * @property-read \Doriiaan\FilamentMenu\Models\MenuItem|null $parent
 */
class MenuItem extends Model
{
    ...
    {
        return config('filament-menu.tables.menu_items', parent::getTable());
    }
    ...
    protected function type(): Attribute
    {
        return Attribute::get(function () {
            return match (true) {
                ...
                is_null($this->linkable) && is_null($this->url) => __('filament-menu::menu.custom_text'),
                default => __('filament-menu::menu.custom_link'),
            };
        });
    }
}
