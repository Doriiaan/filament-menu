...
@php
    /** @var \Doriiaan\FilamentMenu\Models\MenuItem $item */
...
>
        ...
        <div class="flex flex-1 items-center gap-2 truncate">
            ...
            @if ($hasChildren)
                <x-filament::icon-button
                    ...
                    x-bind:title="open ? '{{ trans('filament-menu::menu.items.collapse') }}' : '{{ trans('filament-menu::menu.items.expand') }}'"
                    color="gray"
            ...
            @if (\Doriiaan\FilamentMenu\FilamentMenuPlugin::get()->isIndentActionsEnabled())
    ...
    >
        @foreach ($item->children as $child)
            <x-filament-menu::menu-item :item="$child" :parent=false />
        @endforeach
    </ul>
</li>
